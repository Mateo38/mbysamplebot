...
var facebookmessengerToken = 'EAAOP78EZA4OEBAEBaqWYaD5ZAKPSf0ZCWDquK7eEf7ZB2FuTncztBEmuMWEy7XhZByZCl3ZCDVnZA0ThV8XBwCR3Va8ssVaXIjxZAeGeCvk49pmHpKsHNywu7yMvNOZCglPPXaD8x6HYdtiJPM58msr2zIZCt19oROS2IaFOptfNiJAIQZDZD';
...
app.post('/webhook', function (req, res) {
    ...
    for (var i = 0; i < events.length; i++) {
        ...
        if (event.message && event.message.text) {
            ...
            var messageFromRecast = processUserInput(event.message.text);
...
var processUserInput = function processUserInput(userInput) {
    var recastAnswer = 'Je n\'ai pas compris :-(';
            ...
            if (entityRaceDate) {
                ...
                if (range) {
                    ...
                    //sendMessage(userId,'Tu cherches une course en ' + range[0].toString() + ' et ' + range[1].toString() + ".");
                        ...
                        recastAnswer = 'Je n\'ai pas compris pour quelle p�riode tu recherches une course...';
                    ...
                    recastAnswer = 'Je n\'ai pas compris s\'il y avait une p�riode pour la course recherch�e...';
